  ...
  public void printTicketInfo() {
    System.out.println(
        "Ticket:"
            ...
            + '\''
            + ",\ntime="
            + time.format(DateTimeFormatter.ofPattern(DATA_TIME_FORMAT))
            + ",\nisPromo="
            + isPromo
            + ",\nstadiumSector="
            + stadiumSector
            ...
            + maxAllowedBackpackWeightInKg
            + ",\ncreationTime="
            + creationDate.format(DateTimeFormatter.ofPattern(DATA_TIME_FORMAT))
            + ",\nticketPrice="
            + ticketPrice
